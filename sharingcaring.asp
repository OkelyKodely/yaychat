...
while not rrs.eof
dim categname3
categname3 = rrs("categname")
if instr(application(categname3&"_roomlist"), session("userid") & "") > 0 then
	application(categname3&"_roomlist") = replace(application(categname3&"_roomlist"), session("userid"), "coppersink21")
end if
rrs.movenext
wend
